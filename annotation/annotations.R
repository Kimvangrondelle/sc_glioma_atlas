...
pr3$celltype <- ifelse(pr3$seurat_clusters %in% c(0, 1, 7, 10, 14, 15, 16, 17, 20, 21), "ATumor", pr3$celltype)
...
pr3$celltype <- ifelse(pr3$seurat_clusters %in% c(4, 8, 9, 11, 27), "Astro", pr3$celltype)
...
diaz11136$celltype <- ifelse(diaz11136$seurat_clusters %in% c(4, 5), "ATumor", diaz11136$celltype)
diaz11136$celltype <- ifelse(diaz11136$seurat_clusters %in% c(8), "TAM", diaz11136$celltype)
diaz11136$celltype <- ifelse(diaz11136$seurat_clusters %in% c(3), "Astro", diaz11136$celltype)
...
diaz12017$celltype <- ifelse(diaz12017$seurat_clusters %in% c(1, 2, 4, 5, 6, 7, 9), "ATumor", diaz12017$celltype)
diaz12017$celltype <- ifelse(diaz12017$seurat_clusters %in% c(0, 8), "TAM", diaz12017$celltype)
diaz12017$celltype <- ifelse(diaz12017$seurat_clusters %in% c(3), "Oligo", diaz12017$celltype)
